...
export function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-cream/50 border-r border-sage/10 hidden md:flex flex-col h-screen fixed left-0 top-0 backdrop-blur-xl">
            {/* Logo Area */}
            ...
            {/* User Profile */}
            <div className="p-4 m-4 bg-white/50 rounded-2xl border border-sage/5 hover:border-sage/20 transition-all cursor-pointer group">
